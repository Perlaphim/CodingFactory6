...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        List<Product> products = new ArrayList<>(List.of(new Product("Milk",2.25, 100),
                new Product("Honey", 8.50, 50), new Product("Honey",3.15,200),
                new Product("Oranges",5.90,20)));
...
//        System.out.println(honeySum);
        ...
        Optional<Product> opt = products.stream()
                .filter(p -> p.getPrice() > 8.50)
                .findFirst();

        System.out.println(opt.orElse(null));
        System.out.println(opt.orElse(new Product("Egg", 12.5, 311)));
